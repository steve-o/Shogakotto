...
SHOGAKOTTO=target/classes
SHOGAKOTTO=target/Shogakotto-2.0-SNAPSHOT.jar
...
set -x
$JAVA \
	-cp $SHOGAKOTTO:$COMMONSCLI:$GUAVA:$GSON:$JODA:$LOG4J2:$RFA:$RFAVALUEADD \
	-Dlog4j.configurationFile=log4j2.xml \
	$ENABLEASSERTIONS \
	$ENABLEDISRUPTOR \
	com.thomsonreuters.Shogakotto.Shogakotto $*
